...
public class Homework {
  ...
  /**
   * 1. Повторить все, что было на семинаре.
   ...
   * 3.2 Создать CRUD-контроллер (в котором есть стандартные методы GET DELETE PUT) для класса Project, сервис и репозиторий
